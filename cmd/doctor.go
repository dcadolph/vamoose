...
func doctorChecks(getenv func(string) string) []doctorCheck {
	...
	checks = append(checks,
		...
		doctorCheck{Label: "Leave balance (BambooHR or balance webhook)", OK: set("VAMOOSE_BAMBOOHR_SUBDOMAIN") || set("VAMOOSE_BALANCE_WEBHOOK_URL"), Optional: true, Hint: "set VAMOOSE_BAMBOOHR_* or VAMOOSE_BALANCE_WEBHOOK_URL to read remaining time off with 'vamoose balance'"},
